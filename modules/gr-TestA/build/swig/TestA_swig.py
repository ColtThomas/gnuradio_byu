...
class cleanslate(object):
    ...
    def make(*args, **kwargs):
        ...
        Return a shared_ptr to a new instance of TestA::cleanslate.

        To avoid accidental use of raw pointers, TestA::cleanslate's constructor is in a private implementation class. TestA::cleanslate::make is the public interface for creating new instances.
