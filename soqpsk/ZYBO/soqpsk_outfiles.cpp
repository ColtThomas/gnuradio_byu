...
void bpsk(
	...
	std::ofstream mfoutfp ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/mfout.txt");
	std::ofstream mfinfp ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/mfin.txt");
	std::ofstream decodedBits ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/decodedBits.txt");
	std::ofstream xiFile ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/xi.txt");
	std::ofstream yiFile ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/yi.txt");
	std::ofstream xrFile ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/xr.txt");
	std::ofstream yrFile ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/yr.txt");
	std::ofstream strobeFile ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/strobe.txt");
	std::ofstream muFile ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/mu.txt");
	std::ofstream etFile ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/et.txt");
	std::ofstream epFile ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/ep.txt");
	std::ofstream cthetaFile ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/ctheta.txt");
	std::ofstream sthetaFile ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/stheta.txt");
	std::ofstream stupidFile ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/stupid.txt");
	std::ofstream THETAFile ("/root/UHD_PROGRAMS/SOQPSK/CapturedData/THETA.txt");
	...
	float mf[20] = {   0.010378066969709,
					  ...
					  -0.027017804469398,
					   ...
					   0.023688987704657,
					   0.010378066969709};	
	const int FILTERLENGTH = sizeof(mf)/sizeof(mf[0]);//gives the number of elements in mf
	...
	*pointer = hold_cycles;
    ...
    while(not stop_signal_called and (num_requested_samples != num_total_samps or num_requested_samples == 0)){
		...
		for (sample_number=0; sample_number<samps_per_buff; sample_number += 2){
			...
			mfinfp << processing_sample << "\n";
			mfinfp << processing_sample1 << "\n";
